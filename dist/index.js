...
const oidc_utils_1 = __nccwpck_require__(792);
/**
 ...
 */
var markdown_summary_1 = __nccwpck_require__(840);
...
const http_client_1 = __nccwpck_require__(264);
const auth_1 = __nccwpck_require__(478);
...
const pm = __nccwpck_require__(307);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(587);
            }
            const agentOptions = {
...
var converters = __nccwpck_require__(856),
    indento = __nccwpck_require__(863);
...
const json2md = __nccwpck_require__(865);
